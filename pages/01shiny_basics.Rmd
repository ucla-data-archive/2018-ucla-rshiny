...
The function `sliderInput` is one of many widget functions available in Shiny. We'll explore more of these in the next lesson. For now, let's just concern ourselves with how to add text elements to the existing panels. To see how this works, we'll add some placeholder text to the sidebarPanel and mainPanel sections. Examine the code below, then add the same modifications to your application.
...
### Images
Images can be added to panels as well. In the project folder, you'll find a file called rstudio.png. In order to use this in you application, you will need to copy it to a folder called www in your application folder. Create the folder, copy the file and then add the following as the last element in your mainPanel:  

`img(src = "rstudio.png", height = 140, width = 400)`

#### Challenge:
Remove all the placeholder text and the image we added in this lesson, then add the following. At the bottom fo the sidebar panel, add the image file county_logo.png from the project folder and resize it to a height of 81 and width of 400. At the bottom of the main panel, add the following text: Source: County of Los Angeles Open Data: Public Library Monthly Circulation and make the text "Public Library Monthly Circulation" a link to the following url: https://data.lacounty.gov/Arts-and-Culture/Public-Library-Monthly-Circulation/gf6j-sjun



[Next Lesson](pages/02shiny_basics.html)
